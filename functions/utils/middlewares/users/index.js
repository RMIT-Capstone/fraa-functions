...
const {userAlreadyExistsWithEmail, lecturerAlreadyExistsWithEmail, validateAccountData} = require('./helper');
...
module.exports = async (req, res, next) => {
  ...
  if (path === USERS_ROUTES.CREATE_LECTURER) {
    ...
    const {exists: userExists} = await userAlreadyExistsWithEmail(email);
